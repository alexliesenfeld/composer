    ...
    return (
        ...
        >
            <div className={Classes.DIALOG_BODY}>
                <FormGroup label="File name" labelFor="text-input" helperText={errorText}
                           intent={errorText ? Intent.WARNING : Intent.NONE}>
                    <InputGroup id="text-input" placeholder="Please enter a file name ..."
                                value={value}
                                intent={errorText ? Intent.WARNING : Intent.NONE}
            ...
            <div className={Classes.DIALOG_FOOTER}>
                <div className={Classes.DIALOG_FOOTER_ACTIONS}>
                    ...
                    <Button onClick={() => props.onAccept(value)}
                            intent={Intent.PRIMARY}
                            disabled={!!getErrorText(touched, value, props)}>Create</Button>
                </div>
            </div>
        </Dialog>
    );
