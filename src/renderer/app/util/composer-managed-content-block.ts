...
export class ComposerManagedContentBlock {
    ...
    static extractFrom(content: string): ComposerManagedContentBlock {
        ...
        const payload = content.substring(startIdx, endIdx)
    ...
    addToOrReplaceIn(content: string) {
        const block = HEADER_FILE_COMPOSER_BLOCK_START
